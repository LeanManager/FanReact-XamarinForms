...
namespace FanReact
{
	...
	/// In which case you must set <see cref="CustomReorderCommand"/> 
	...
	{
		public static BindableProperty CustomReorderCommandProperty = BindableProperty.Create("CustomReorderCommand", typeof(Command<ReorderCommandParam>), typeof(MovableViewCell));
		...
		/// </remarks>
		public Command<ReorderCommandParam> CustomReorderCommand
		{
			get { return (Command<ReorderCommandParam>)GetValue(CustomReorderCommandProperty); }
			set { SetValue(CustomReorderCommandProperty, value); }
		}
