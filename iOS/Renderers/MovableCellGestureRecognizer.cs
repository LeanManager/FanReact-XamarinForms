			...
			switch (State)
			{
				...
				case UIGestureRecognizerState.Changed:
					...
					if (!Equals(sourceOrNewAppliedIndexPath, newRowIndexPath))
					{
						...
						{
							cell.CustomReorderCommand.Execute(new ReorderCommandParam(sourceOrNewAppliedIndexPath.Row, sourceOrNewAppliedIndexPath.Section, newRowIndexPath.Row, newRowIndexPath.Section));
						}
